...
namespace
{
    ...
    template<typename TF, Surface_model surface_model> __device__
    void diff_uvw_body(const int i, const int j, const int k,
    ...
    template<typename TF, Surface_model surface_model> __device__
    void diff_c_body(const int i, const int j, const int k,
    ...
    template<typename TF> __device__
    void calc_dnmul_body(const int i, const int j, const int k,
